...
6. `Running IMPACTncd England on your own computer — a beginner's guide` - 19 edges
7. `Adding R or system dependencies` - 18 edges
8. `HSE_ts.fst (Health Survey England time series)` - 18 edges
9. `🔄 Development workflow` - 17 edges
10. `simcpp()` - 16 edges
...
Cohesion: 0.21
Nodes (12): 10. Run a policy scenario, 11. Read the built-in tutorials (vignettes), 12. Troubleshooting, 12. Updating and cleaning up, 13. Updating and cleaning up, code:r (# simulate.R — baseline vs. a BMI policy), code:r (vignette(package = "IMPACTncdEngland")), code:r (doc <- system.file("doc", package = "IMPACTncdEngland")) (+4 more)

### Community 100 - "Community 100"
Cohesion: 0.33
Nodes (6): 2. Install Docker, code:bash (brew install coreutils), code:bash (sudo usermod -aG docker $USER), Linux, macOS, Windows
