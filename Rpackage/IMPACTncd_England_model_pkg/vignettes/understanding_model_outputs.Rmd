...
The collapse applies to every family whose summaries carry `agegrp`: the main tables, all-cause mortality by disease, the cost-effectiveness tables and the equity tables. Two families are outside it by construction — the disease-characteristics summaries have no `agegrp` column at all, and the exposure (`xps_*`) tables are stratified by `agegrp20` (`30-49`, `50-69`, `70-89`, `90+`, `All`), a different variable that a split at 65 would bisect.
