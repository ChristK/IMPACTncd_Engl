---
title: "How to run scenarios in IMPACTncd_Engl"
author: "Dr. Chris Kypridemos, Dr. Anna Head, Adithi R. Upadhya"
date: "11 March, 2024"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{How to run scenarios in IMPACTncd_Engl}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---


In this vignette, we will run three example scenarios to demonstrate the sorts of alternative scenarios that can be run in IMPACTncd_Engl:
...
For our alternative scenarios, we will set the first year the change starts to 2013. We run the baseline scenario before the alternative scenarios so that we can compare results. The results from each additional scenario get appended to the baseline scenario.

1. Set up the simulation parameters following steps 1-4 of the [How to run a test of IMPACTncd_Engl]() vignette. 
...
IMPACTncd$run(mc = 1:2, multicore = FALSE, scenario_nam = "sc0")  IMPACTncd$export_summaries(multicore = FALSE)
```
